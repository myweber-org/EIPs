...
def validate_dataframe(df):
    """
    Validate the DataFrame by checking for missing values and data types.
    ...
    print(f"DataFrame has {validation_result['total_rows']} rows and {validation_result['total_columns']} columns.")
    print(f"Total missing values: {validation_result['missing_values']}")
