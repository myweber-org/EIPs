...
if __name__ == "__main__":
    ...
    df_normalized = normalize_minmax(df_no_outliers, 'feature_b')
    df_final = standardize_zscore(df_normalized, 'feature_c')
...
def filter_by_threshold(data, threshold):
    """
    Filter numeric data by removing values below a given threshold.
    Returns a list of values that meet or exceed the threshold.
    """
