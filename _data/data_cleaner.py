...
if __name__ == "__main__":
    ...
    print("Normalized values range:", normalized.min(), "to", normalized.max())
    
    # Full cleaning pipeline
    final_cleaned = clean_dataset(sample_data)
    print("Final cleaned shape:", final_cleaned.shape)
    
    # Validation
    is_valid, message = validate_dataframe(final_cleaned)
