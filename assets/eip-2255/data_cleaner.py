...
if __name__ == "__main__":
    ...
    sample_data.loc[np.random.choice(1000, 50), 'feature1'] = np.random.uniform(200, 300, 50)
    ...
    print(f"Missing values: {cleaned_summary['missing_values']}")import numpy as np
import pandas as pd
