...
if __name__ == "__main__":
    ...
    sample_data = {
        ...
        'B': [10, 20, 20, 30, 40, 50, 60, None, 80, 90],
    ...
    # Remove outliers from column C
    no_outliers = remove_outliers(cleaned, 'C', method='iqr')
...
def clean_dataset(df, drop_duplicates=True, fill_missing='mean'):
    ...
    if missing_count > 0:
        ...
        if fill_missing == 'mean':
            ...
            print("Invalid fill_missing method. Skipping missing value handling.")
...
def example_usage():
    ...
    print(f"After outlier removal: {clean_df.shape}")
...
if __name__ == "__main__":
    ...
    sample_data.loc[1001] = [-100, -50, -50]
    
    print("Original data shape:", sample_data.shape)
    print("\nOriginal statistics for column 'A':")
    print(get_statistics(sample_data, 'A'))
    
    cleaned_data = clean_numeric_data(sample_data, ['A', 'B'])
    
    print("\nCleaned data shape:", cleaned_data.shape)
    print("\nCleaned statistics for column 'A':")
    print(get_statistics(cleaned_data, 'A'))
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    cleaned = clean_csv_data('sample_data.csv', missing_strategy='mean', columns_to_drop=['C'])
    print("Cleaned data:")
    print(cleaned)
...
def validate_data(df, required_columns=None, check_nulls=True, check_duplicates=True):
    """
    Validate data quality
    """
    validation_results = {}
...
def load_and_clean_data(filepath, cleaning_steps=None):
    ...
    if cleaning_steps:
        for step in cleaning_steps:
            getattr(cleaner, step['method'])(**step.get('kwargs', {}))
