...
if __name__ == "__main__":
    ...
    is_valid = validate_data(cleaned, required_columns=['id', 'name', 'age'])
...
def clean_dataset(df: pd.DataFrame, operations: List[str] = None) -> pd.DataFrame:
    ...
    default_operations = ['remove_duplicates', 'handle_missing_values']
    operations_to_run = operations if operations else default_operations
