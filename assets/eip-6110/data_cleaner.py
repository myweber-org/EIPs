...
if __name__ == "__main__":
    ...
    print(df)
    print("\nCleaned DataFrame:")
    cleaned = clean_dataset(df, columns_to_check=['id', 'value'], fill_missing='mean')
    print(cleaned)
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    for column, column_stats in stats.items():
        print(f"\n{column}:")
        print(f"  Original count: {column_stats['original']['count']}")
        print(f"  Cleaned count: {column_stats['cleaned']['count']}")
