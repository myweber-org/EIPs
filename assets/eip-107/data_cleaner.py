...
class DataCleaner:
    ...
    def summary(self):
        ...
        return summary_stats, missing_valuesimport pandas as pd
...
def validate_data(df, required_columns=None, check_missing=True, check_inf=True):
    """
...
if __name__ == "__main__":
    ...
    print(cleaned_data[['feature1', 'feature2', 'feature3']].describe())
import numpy as np
...
if __name__ == "__main__":
    sample_data = {
        ...
        'email': ['john@example.com', 'jane@test.org', 'john@example.com', 'invalid-email', 'alice@company.co'],
        'age': [25, 30, 25, 35, 28]
    }
