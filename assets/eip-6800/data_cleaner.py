...
if __name__ == "__main__":
    ...
    final_df = clean_numeric_columns(cleaned_df, columns=['score'])
    print("Final DataFrame with cleaned numeric columns:")
    print(final_df)
    print(f"Score column dtype: {final_df['score'].dtype}")