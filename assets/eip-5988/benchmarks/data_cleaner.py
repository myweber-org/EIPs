...
if __name__ == "__main__":
    ...
    print("Original summary:", calculate_summary_stats(sample_data, 'values'))
...
if __name__ == "__main__":
    sample_data = {
        'values': [10, 12, 12, 13, 12, 11, 14, 13, 15, 100, 12, 11, 13, 12, 14]
    }
...
if __name__ == "__main__":
    ...
    # Clean the data
    cleaned_df = clean_dataset(df, missing_strategy='fill', fill_value=0)
    print("\nCleaned DataFrame:")
    print(cleaned_df)
    ...
    # Detect outliers
    outliers = detect_outliers_iqr(cleaned_df, 'B')
    print(f"\nOutliers in column B: {outliers.sum()}")
