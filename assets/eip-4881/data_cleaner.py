...
if __name__ == "__main__":
    ...
    print(get_summary_statistics(sample_df, ['A', 'B', 'C']))
    
    cleaned_df = clean_dataset(sample_df, ['A', 'B', 'C'], outlier_method='iqr', normalize_method='minmax')
...
if __name__ == "__main__":
    ...
    print("Original data:")
    print(sample_data)
    print("\nCleaned data (using mean for missing values):")
    cleaned = clean_dataset(sample_data, missing_strategy='mean')
    print(cleaned)
    
    is_valid, message = validate_data(cleaned, required_columns=['feature_a', 'feature_b'])
