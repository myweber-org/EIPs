...
def sample_data_cleaning():
    ...
    try:
        validate_dataframe(cleaned, ['product_name', 'price', 'quantity_in_stock'])
...
if __name__ == "__main__":
    ...
    original_quality = validate_data_quality(sample_data, numeric_cols)
    cleaned_quality = validate_data_quality(cleaned_data, numeric_cols)
    
    print("Original data shape:", sample_data.shape)
    print("Cleaned data shape:", cleaned_data.shape)
    print("\nOriginal data quality report:")
    print(original_quality[['missing_percentage', 'mean', 'std']].head())
    print("\nCleaned data quality report:")
    print(cleaned_quality[['missing_percentage', 'mean', 'std']].head())