...
if __name__ == "__main__":
    ...
    print("\nSummary statistics:")
    print(summary_statistics(cleaned))
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    stats = calculate_summary_statistics(sample_df, 'value')
    ...
    print(f"\nAfter normalization: {normalized_df.shape}")
    print(normalized_df[['value', 'value_normalized']].head())
    
    filled_df = handle_missing_values(normalized_df, 'value', strategy='mean')
    print(f"\nAfter handling missing values: {filled_df.shape}")
    print(filled_df[['value', 'value_normalized']].head())import pandas as pd
...
if __name__ == "__main__":
    ...
    is_valid, message = validate_dataframe(cleaned_df, ['A', 'B'])
    print(f"\nValidation: {message}")
import numpy as np
import pandas as pd
from scipy import stats
