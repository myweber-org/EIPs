...
if __name__ == "__main__":
    ...
    print(f"After normalization - Mean of feature_a: {normalized_df['feature_a'].mean():.4f}")
    print(f"After filling - Missing values in feature_a: {filled_df['feature_a'].isnull().sum()}")