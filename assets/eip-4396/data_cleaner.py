...
def clean_dataset(df, remove_duplicates=True, fill_na_method='drop'):
    ...
    fill_na_method (str): Method to handle missing values ('drop', 'fill_mean', 'fill_median').
    ...
    if fill_na_method == 'drop':
        ...
        raise ValueError("Invalid fill_na_method. Choose from 'drop', 'fill_mean', 'fill_median'")
