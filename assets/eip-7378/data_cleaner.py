...
if __name__ == "__main__":
    ...
    print("Summary stats before cleaning:", calculate_summary_stats(sample_data, 'values'))
    
    cleaned_data = remove_outliers_iqr(sample_data, 'values')
    print("\nCleaned data shape:", cleaned_data.shape)
    print("Summary stats after cleaning:", calculate_summary_stats(cleaned_data, 'values'))
