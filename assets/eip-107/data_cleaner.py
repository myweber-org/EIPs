...
if __name__ == "__main__":
    ...
    print("Cleaned statistics for feature_a:", calculate_statistics(cleaned_data, 'feature_a'))
    print("\nNormalized columns added:", [col for col in cleaned_data.columns if 'normalized' in col])
import numpy as np
import pandas as pd
from scipy import stats
...
def create_sample_data():
    ...
    for idx in indices:
        ...
        df.loc[idx, col] = np.random.uniform(500, 1000)
